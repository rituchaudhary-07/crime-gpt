...
function AuthFormContainer({ isSignIn, onToggle, onSignInSubmit, onSignUpSubmit, onGoogleClick }: { isSignIn: boolean; onToggle: () => void; onSignInSubmit?: (e: React.FormEvent<HTMLFormElement>) => void; onSignUpSubmit?: (e: React.FormEvent<HTMLFormElement>) => void; onGoogleClick?: () => void; }) {
    return (
        <div className="mx-auto grid w-[350px] gap-2">
            ...
            <Button variant="outline" type="button" onClick={onGoogleClick || (() => console.log("UI: Google button clicked"))}>
...
const defaultSignInContent = {
    image: {
        ...
        alt: "Law enforcement and legal intelligence workspace"
    },
    quote: {
...
const defaultSignUpContent = {
    image: {
        ...
        alt: "Vibrant cyber law enforcement portal"
    },
    quote: {
...
export function AuthUI({ signInContent = {}, signUpContent = {}, onSignInSubmit, onSignUpSubmit, onGoogleClick }: AuthUIProps) {
  ...
  return (
    <div className="w-full min-h-screen md:grid md:grid-cols-2">
      ...
      <div className="flex h-screen items-center justify-center p-6 md:h-auto md:p-0 md:py-12">
        <AuthFormContainer isSignIn={isSignIn} onToggle={toggleForm} onSignInSubmit={onSignInSubmit} onSignUpSubmit={onSignUpSubmit} onGoogleClick={onGoogleClick} />
      </div>
