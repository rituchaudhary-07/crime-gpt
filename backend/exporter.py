...
def generate_chat_pdf_report(chat_messages: list, username: str = "Officer", case_title: str = "General Consultation") -> bytes:
    ...
    story = []
    story.append(Paragraph("<b>CRIMEGPT LEGAL INTELLIGENCE - CHAT TRANSCRIPT</b>", header_style))
    ...
    for msg in chat_messages:
        ...
        if role == 'USER':
            ...
            story.append(Paragraph(f"<b>[CRIMEGPT AI ASSISTANT]</b> - {timestamp}", meta_style))
