...
def build_analysis_markdown(summary: str, citations: List[Dict[str, Any]], fir_draft_text: str, checklist: List[str]) -> str:
    ...
    return f"""# NyayaIQ Automated Legal Analysis
...
---
Generated by NyayaIQ AI assistant. Subject to Investigating Officer manual sign-off.
"""
    ...
    try:
        prompt = f"""
        You are NyayaIQ, an advanced AI legal intelligence assistant designed for Indian Law Enforcement.
        Analyze this case:
        - Title: {case_title}
        - Date: {date}
        - Location: {location}
        ...
        """
        messages = [
            {"role": "system", "content": "You are NyayaIQ, an advanced AI legal intelligence assistant designed for Indian Law Enforcement."},
